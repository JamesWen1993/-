...
//    id<CDUserModel> selfUser = [[CDChatManager manager].userDelegate getUserById:[CDChatManager manager].selfId ];
    id<CDUserModel> selfUser = [[CDChatManager manager].userDelegate getUserById:[CDChatManager manager].selfId avatarUrl:[CDChatManager manager].avatarUrl];
...
- (XHMessage *)getXHMessageByMsg:(AVIMTypedMessage *)msg {
    id <CDUserModel> fromUser = [[CDChatManager manager].userDelegate getUserById:msg.clientId avatarUrl:[CDChatManager manager].avatarUrl];
    NSLog(@"-----------------------6666666666666666%@",msg.clientId);
    XHMessage *xhMessage;
...
//    NSLog(@"-----------------------777777777777777%@",[fromUser avatarUrl]);
